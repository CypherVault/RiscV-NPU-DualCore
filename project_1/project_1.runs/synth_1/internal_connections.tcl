...
namespace eval ::optrace {
  variable script "C:/Users/maxpro/Desktop/440Project RISCVCORE/project_1/project_1.runs/synth_1/internal_connections.tcl"
...
synth_design -top internal_connections -part xc7z007sclg225-1
...
write_checkpoint -force -noxdef internal_connections.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file internal_connections_utilization_synth.rpt -pb internal_connections_utilization_synth.pb"  } 
