...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/datamemIP_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef datamemIP_tb_include_vh_"
	puts $fp "`define datamemIP_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/datamemIP_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "datamemIP_bfm_${i}"
...
remove_files -quiet -fileset sim_1 datamemIP_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top datamemIP_tb [get_filesets sim_1]
