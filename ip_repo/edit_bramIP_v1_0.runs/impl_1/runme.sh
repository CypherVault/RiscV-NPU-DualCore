...
HD_PWD='c:/users/chris/desktop/riscv-npu-dualcore/ip_repo/edit_bramIP_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bytewrite_ram_1b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bytewrite_ram_1b.tcl -notrace
