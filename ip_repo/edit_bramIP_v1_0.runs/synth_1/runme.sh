...
HD_PWD='c:/users/chris/desktop/riscv-npu-dualcore/ip_repo/edit_bramIP_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bytewrite_ram_1b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bytewrite_ram_1b.tcl
