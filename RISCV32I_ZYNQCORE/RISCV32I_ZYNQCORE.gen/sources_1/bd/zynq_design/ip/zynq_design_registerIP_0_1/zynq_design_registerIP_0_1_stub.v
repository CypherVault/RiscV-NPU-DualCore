...
//               c:/Users/Chris/Desktop/RiscV-NPU-DualCore/RISCV32I_ZYNQCORE/RISCV32I_ZYNQCORE.gen/sources_1/bd/zynq_design/ip/zynq_design_registerIP_0_1/zynq_design_registerIP_0_1_stub.v
...
(* CHECK_LICENSE_TYPE = "zynq_design_registerIP_0_1,registerIP,{}" *) (* core_generation_info = "zynq_design_registerIP_0_1,registerIP,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=registerIP,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_S01_AXI_DATA_WIDTH=32,C_S01_AXI_ADDR_WIDTH=32}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "registerIP,Vivado 2024.2" *) 
module zynq_design_registerIP_0_1(s01_axi_aclk, s01_axi_aresetn, 
