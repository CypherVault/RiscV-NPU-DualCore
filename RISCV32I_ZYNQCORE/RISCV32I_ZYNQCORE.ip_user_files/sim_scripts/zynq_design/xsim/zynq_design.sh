...
#
# Script generated by Vivado on Wed Feb 19 19:13:24 -0500 2025
...
simulate()
{
  xsim zynq_design -key {Behavioral:sim_1:Functional:zynq_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_375a.protoinst" -protoinst "protoinst_files/zynq_design.protoinst" -log simulate.log
}
