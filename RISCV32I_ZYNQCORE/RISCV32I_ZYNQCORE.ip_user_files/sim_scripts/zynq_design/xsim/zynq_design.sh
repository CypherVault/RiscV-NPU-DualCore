...
#
# Script generated by Vivado on Sun Feb 23 20:51:38 -0500 2025
...
#
# Usage        : zynq_design.sh
#                zynq_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                zynq_design.sh [-reset_run]
#                zynq_design.sh [-reset_log]
#                zynq_design.sh [-help]
#
...
export RDI_DATADIR="F:/Vivado/2024.2/data"
...
# script info
echo -e "zynq_design.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./zynq_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L xlconstant_v1_1_9 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot zynq_design xil_defaultlib.zynq_design xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="F:/Vivado/2024.2/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_19 processing_system7_vip_v1_0_21 lib_cdc_v1_0_3 proc_sys_reset_v5_0_16 xlconstant_v1_1_9 smartconnect_v1_0 axi_register_slice_v2_1_33)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb zynq_design.wdb xsim.dir libdpi.so)
...
Usage: zynq_design.sh [-step]\n\
Usage: zynq_design.sh [-lib_map_path]\n\
Usage: zynq_design.sh [-reset_run]\n\
Usage: zynq_design.sh [-reset_log]\n\
Usage: zynq_design.sh [-keep_index]\n\
