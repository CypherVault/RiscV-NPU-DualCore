...
#                script (type 'zynq_design.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Chris/Desktop/RiscV-NPU-DualCore/RISCV32I_ZYNQCORE/RISCV32I_ZYNQCORE.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
