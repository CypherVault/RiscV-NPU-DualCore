...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ zynq_design_controlsubsystemIP_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "zynq_design_controlsubsystemIP_0_0,controlsubsystemIP,{}" *) (* core_generation_info = "zynq_design_controlsubsystemIP_0_0,controlsubsystemIP,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=controlsubsystemIP,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "controlsubsystemIP,Vivado 2024.2" *) 
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s05_axi_aclk, s05_axi_aresetn, 
...
/* synthesis syn_force_seq_prim="s05_axi_aclk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 S05_AXI_CLK CLK" *) (* x_interface_mode = "slave S05_AXI_CLK" *) (* x_interface_parameter = "XIL_INTERFACENAME S05_AXI_CLK, ASSOCIATED_BUSIF S05_AXI, ASSOCIATED_RESET s05_axi_aresetn, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zynq_design_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *) input s05_axi_aclk /* synthesis syn_isclock = 1 */;
