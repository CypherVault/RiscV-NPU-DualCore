% Autogenerated file: Sat Mar 22 18:54:31 2025
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("zynq_7000_tutorial_3",pwd) ;
...
skippedParameters = [];
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        ...
        func_Initialize_Prototype.HeaderFile = 'zynq_7000_tutorial_3.h';
    func_Initialize_Prototype.SourceFile = 'zynq_7000_tutorial_3.cpp';
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'zynq_7000_tutorial_3_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        ...
        func_OutputUpdate_Prototype.HeaderFile = 'zynq_7000_tutorial_3.h';
    func_OutputUpdate_Prototype.SourceFile = 'zynq_7000_tutorial_3.cpp';
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'zynq_7000_tutorial_3_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        ...
        func_Terminate_Prototype.HeaderFile = 'zynq_7000_tutorial_3.h';
    func_Terminate_Prototype.SourceFile = 'zynq_7000_tutorial_3.cpp';
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['zynq_7000_tutorial_3_terminate'];
        codeInfo.TerminateFunctions =  [codeInfo.TerminateFunctions, func_Terminate_Interface'];
            ...
            type_RTModel.Identifier = 'RT_MODEL_zynq_7000_tutorial_3_T';
        ...
        Var_RTModel = RTW.Variable(Ptrtype_RTModel_1_0.BaseType, 'zynq_7000_tutorial_3_M_');
        Var_RTModel.Owner           = 'zynq_7000_tutorial_3';
        Var_RTModel.DeclarationFile = 'zynq_7000_tutorial_3.h';
            Var_RTModel.DefinitionFile  = 'zynq_7000_tutorial_3.cpp';
        

        % Pointer Variable: PtrVar_RTModel
        PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'zynq_7000_tutorial_3_M', Var_RTModel);
