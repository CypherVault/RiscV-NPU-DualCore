...
`define INSTR_MEM_BASE 32'h40020000  // Instruction memory base address
`define CTRL_BASE 32'h40000000
`define REG_BASE 32'h7FFF8000  // Register IP base address
`define DATA_MEM_BASE 32'h40010000 // Data memory base address
