...
static void zynq_7000_tutoria_contributions(real_T weights_data[], int32_T
  weights_size[2], int32_T indices_data[], int32_T indices_size[2])
{
  static const real_T f[224]{ 3.3571428571428572, 9.0714285714285712,
  ...
  static const int16_T e[224]{ -9, -3, 3, 9, 14, 20, 26, 31, 37, 43, 49, 54, 60,
  ...
  for (i2 = 0; i2 < 25; i2++) {
    for (xoffset = 0; xoffset < 224; xoffset++) {
      zynq_7000_tutorial_3_B.b_indices[xoffset + 224 * i2] = e[xoffset] + i2;
    }
  }
  ...
  for (xoffset = 0; xoffset < 25; xoffset++) {
    for (k = 0; k < 224; k++) {
      i2 = 224 * xoffset + k;
      zynq_7000_tutorial_3_B.absx3[i2] = f[k] - zynq_7000_tutorial_3_B.absx2[i2];
    }
  }
  ...
  for (xoffset = 0; xoffset < 25; xoffset++) {
    if (copyCols[xoffset]) {
      b_data[i2] = static_cast<int8_T>(xoffset + 1);
      i2++;
    }
  }
  ...
  for (i2 = 0; i2 < 224; i2++) {
    for (k = 0; k < a; k++) {
      weights_data[k + a * i2] = zynq_7000_tutorial_3_B.absx3[(b_data[k] - 1) *
        224 + i2];
    }
  }
  ...
  for (xoffset = 0; xoffset < 25; xoffset++) {
    if (copyCols[xoffset]) {
      c_data[i2] = static_cast<int8_T>(xoffset + 1);
      i2++;
    }
  }
  ...
  for (i2 = 0; i2 < 224; i2++) {
    for (k = 0; k < a; k++) {
      indices_data[k + a * i2] = zynq_7000_tutorial_3_B.b_indices[(c_data[k] - 1)
        * 224 + i2];
    }
  }
}
...
static void zynq_7000_tutor_contributions_p(real_T weights_data[], int32_T
  weights_size[2], int32_T indices_data[], int32_T indices_size[2])
{
  static const real_T f[224]{ 2.1071428571428572, 5.3214285714285712,
  ...
  static const int16_T e[224]{ -5, -2, 2, 5, 8, 11, 14, 18, 21, 24, 27, 31, 34,
  ...
  for (i2 = 0; i2 < 15; i2++) {
    for (xoffset = 0; xoffset < 224; xoffset++) {
      zynq_7000_tutorial_3_B.b_indices_k[xoffset + 224 * i2] = e[xoffset] + i2;
    }
  }
  ...
  for (xoffset = 0; xoffset < 15; xoffset++) {
    for (k = 0; k < 224; k++) {
      i2 = 224 * xoffset + k;
      zynq_7000_tutorial_3_B.absx3_c[i2] = f[k] -
  ...
  for (i2 = 0; i2 < 224; i2++) {
    for (k = 0; k < a; k++) {
      weights_data[k + a * i2] = zynq_7000_tutorial_3_B.absx3_c[(b_data[k] - 1) *
        224 + i2];
    }
  }
  ...
  for (i2 = 0; i2 < 224; i2++) {
    for (k = 0; k < a; k++) {
      indices_data[k + a * i2] = zynq_7000_tutorial_3_B.b_indices_k[(c_data[k] -
        1) * 224 + i2];
    }
  }
}
...
static void zyn_DeepLearningNetwork_predict(mobilenetv20_0 *obj, const uint8_T
  varargin_1[150528], real32_T varargout_1[1000])
{
  cell_wrap_13_zynq_7000_tutori_T outMiniBatchGroup;
  for (int32_T i{0}; i < 150528; i++) {
    zynq_7000_tutorial_3_B.indata.f1[i] = varargin_1[i];
  }

  for (int32_T p{0}; p < 3; p++) {
    for (int32_T i{0}; i < 224; i++) {
      for (int32_T i_0{0}; i_0 < 224; i_0++) {
        zynq_7000_tutorial_3_B.inMiniBatchGroup.f1[(i_0 + 224 * i) + 50176 * p] =
          zynq_7000_tutorial_3_B.indata.f1[(224 * i_0 + i) + 50176 * p];
      }
    }
  }

  std::memcpy(obj->getInputDataPointer(0),
              &zynq_7000_tutorial_3_B.inMiniBatchGroup.f1[0],
              static_cast<uint32_T>(obj->getLayerOutputSize(0, 0)));
  obj->predict();
  std::memcpy(&outMiniBatchGroup.f1[0], obj->getLayerOutput(67, 0), static_cast<
              uint32_T>(obj->getLayerOutputSize(67, 0)));
  std::memcpy(&varargout_1[0], &outMiniBatchGroup.f1[0], 1000U * sizeof(real32_T));
}
...
void zynq_7000_tutorial_3_step(void)
{
  ...
  // S-Function (waijung2_basic_customcode): '<Root>/Basic Custom Code'
  {
    //*
    //  Custom Code Block Output Function
    //  Block: <Root>/Basic Custom Code
    ...
    output_BasicCustomCode( &zynq_7000_tutorial_3_B.MatrixConcatenate[0],
      &zynq_7000_tutorial_3_B.MatrixConcatenate[921600],
      &zynq_7000_tutorial_3_B.MatrixConcatenate[1843200]);
  }
  ...
  for (i = 0; i < 2160; i++) {
    for (outRInd = 0; outRInd < 224; outRInd++) {
      ...
      for (int32_T k{0}; k < b_weights_size[0]; k++) {
        sumVal1 += static_cast<real_T>(zynq_7000_tutorial_3_B.MatrixConcatenate
          [(1280 * i + zynq_7000_tutorial_3_B.b_indices_data[linearInds]) - 1]) *
          zynq_7000_tutorial_3_B.b_weights_data[linearInds];
        linearInds++;
      }

      if (sumVal1 > 255.0) {
        zynq_7000_tutorial_3_B.APartialResize[outRInd + 224 * i] = MAX_uint8_T;
      } else if (sumVal1 < 0.0) {
        zynq_7000_tutorial_3_B.APartialResize[outRInd + 224 * i] = 0U;
      } else if (sumVal1 < 4.503599627370496E+15) {
        if (sumVal1 >= 0.5) {
          zynq_7000_tutorial_3_B.APartialResize[outRInd + 224 * i] =
            static_cast<uint8_T>(std::floor(sumVal1 + 0.5));
        } else {
          zynq_7000_tutorial_3_B.APartialResize[outRInd + 224 * i] =
            static_cast<uint8_T>(sumVal1 * 0.0);
        }
      } else {
        zynq_7000_tutorial_3_B.APartialResize[outRInd + 224 * i] =
          static_cast<uint8_T>(sumVal1);
      }
    }
  }
  ...
  for (i = 0; i < 3; i++) {
    for (outRInd = 0; outRInd < 224; outRInd++) {
      linearInds = 161280 * i + outRInd;
      for (int32_T k{0}; k < 224; k++) {
        int32_T b_linearInds;
        sumVal1 = 0.0;
        b_linearInds = b_weights_size[0] * k;
        for (int32_T b_k{0}; b_k < b_weights_size[0]; b_k++) {
          sumVal1 += static_cast<real_T>(zynq_7000_tutorial_3_B.APartialResize
            [(zynq_7000_tutorial_3_B.indices_data[b_linearInds] - 1) * 224 +
            linearInds]) * zynq_7000_tutorial_3_B.weights_data[b_linearInds];
          b_linearInds++;
        }

        if (sumVal1 > 255.0) {
          zynq_7000_tutorial_3_B.B[(outRInd + 224 * k) + 50176 * i] =
            MAX_uint8_T;
        } else if (sumVal1 < 0.0) {
          zynq_7000_tutorial_3_B.B[(outRInd + 224 * k) + 50176 * i] = 0U;
        } else if (sumVal1 < 4.503599627370496E+15) {
          if (sumVal1 >= 0.5) {
            zynq_7000_tutorial_3_B.B[(outRInd + 224 * k) + 50176 * i] =
              static_cast<uint8_T>(std::floor(sumVal1 + 0.5));
  ...
  if (!std::isnan(x[0])) {
    ...
    outRInd = 2;
    exitg1 = false;
    while ((!exitg1) && (outRInd < 1001)) {
      if (!std::isnan(x[outRInd - 1])) {
        i = outRInd;
        exitg1 = true;
      } else {
        outRInd++;
  ...
  if (i == 0) {
    ...
    real32_T ex;
    ex = x[i - 1];
    for (outRInd = i; outRInd + 1 < 1001; outRInd++) {
      if (ex < x[outRInd]) {
        ex = x[outRInd];
        i = outRInd + 1;
      }
  ...
  switch (convert_to_enum_mobilenetv2_lab(i)) {
  ...
  strncpy(&tmp[0], &rtb_ComposeString_0[0], 64U);
  for (i = 0; i < 64; i++) {
...
{
  // CleanupRuntimeResources for MATLAB Function: '<S1>/MLFB'
  ...
  // End of CleanupRuntimeResources for MATLAB Function: '<S1>/MLFB'
}
