...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = controlsubsystemIP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = controlsubsystemIP_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = datamemIP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = datamemIP_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = instructionmemIP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = instructionmemIP_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = registerIP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = registerIP_0
END
