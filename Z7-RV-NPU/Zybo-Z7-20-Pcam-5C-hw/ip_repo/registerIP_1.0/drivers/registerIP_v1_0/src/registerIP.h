...
#define REGISTERIP_REGISTER_AXI_SLV_REG0_OFFSET 0
#define REGISTERIP_REGISTER_AXI_SLV_REG1_OFFSET 4
#define REGISTERIP_REGISTER_AXI_SLV_REG2_OFFSET 8
#define REGISTERIP_REGISTER_AXI_SLV_REG3_OFFSET 12
